  ...
  return (
    <div className="max-w-[820px] mx-auto space-y-5">
      ...
      <Card padding="p-0" className="overflow-hidden">
        {/* Blue banner — avatar left, name/role right */}
        <div
          className="px-6 py-5"
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative flex-shrink-0">
                <div style={{ border: '3px solid rgba(0,48,135,0.7)', borderRadius: '50%', display: 'inline-flex', boxShadow: '0 0 0 2px rgba(255,255,255,0.25)' }}>
                  <Avatar
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1 flex-wrap">
                  ...
                  <span className="text-xs text-blue-200">{user.department}</span>
                </div>
              </div>
            </div>
            ...
            <Button
              ...
              icon={<Edit3 size={13} />}
              className="bg-white/20 text-white hover:bg-white/30 border-0 flex-shrink-0"
            >
              Редактировать
            </Button>
          </div>
      ...
      {activeTab === 'overview' && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <Card>
            <CardHeader title="Карьерная цель" icon={<TrendingUp size={18} />} iconBg="#E8F0FA" iconColor="#005DB9" />
          ...
          <Card>
            <CardHeader title="Ключевые метрики" icon={<Star size={18} />} iconBg="#FEF3C7" iconColor="#F59E0B" />
            <div className="space-y-3">
              {[
                { label: 'Готовность к переходу', value: user.readiness,           color: 'accent' },
                { label: 'Вовлечённость',          value: user.engagement,          color: 'success' },
          ...
          <Card>
            ...
            <div className="flex flex-wrap gap-2">
              {user.skills.map((skill, i) => (
                <span key={i} className="flex items-center gap-1 px-3 py-1.5 rounded-xl bg-success-light text-success text-sm font-semibold">
          ...
          <Card>
            ...
            <div className="flex flex-wrap gap-2">
              {user.skillGaps.map((skill, i) => (
                <span key={i} className="px-3 py-1.5 rounded-xl bg-warning-light text-warning text-sm font-semibold border border-warning/20">
                  + {skill}
                </span>
              ))}
            </div>
            <Button variant="secondary" size="md" onClick={() => navigate('/learning')}
              className="mt-4" iconRight={<ChevronRight size={14} />}>
      ...
      {activeTab === 'career' && (
        <Card>
          <CardHeader title="Карьерный маршрут" icon={<TrendingUp size={18} />} iconBg="#E8F0FA" iconColor="#005DB9" />
          <div className="space-y-3">
          ...
          <Button variant="primary" size="md" onClick={() => navigate('/career')}
